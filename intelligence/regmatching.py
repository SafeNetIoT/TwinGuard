...
df.to_csv("../data/fingerprinting/classified_intrusion_log.csv", index=False)
...
summary_df.to_csv("../data/fingerprinting/intrusion_category_summary.csv", index=False)
...
top5_df.to_csv("../data/fingerprinting/top5_attack_signatures.csv", index=False)
