...
def process_file(input_path, output_path):
   ...
   # ====== Category Encoding ======
    ...
    df = df[df["category"].isin(CATEGORY_ORDER)]  # Drop all other categories

    # Encode using fixed label order
    le_cat = LabelEncoder()
    ...
    HTTP_METHODS = [
    "GET", "POST", "OPTIONS", "HEAD", "PRI", "PROPFIND", "KGSY", "CONNECT", "LFIM", "HBLB", "XPDU",
    "PUT", "DELETE", "SSTP_DUPLEX_POST", "PDWB", "RXRM", "VFTF", "CENG", "UKUP", "IXNJ", "JIPW", 
    "OMAC", "EOFQ", "KJLE", "TWUT", "AMJL", "NZWJ", "ZVGU", "ZGKC", "UFSR", "QOQJ", "UQSI", "ARYC", 
    "WLGK", "ZSDLKFJ2", "OEHR", "NMRE", "MGLI", "KMKQ", "RCIJ", "OLNL", "QPOH", "BIPU", "CYFD", 
    "PATCH", "ELEJ", "YPYJ", "KVFA", "REHE", "TRACE", "OTHER"]
    ...
    label_mapping_path = "../data/encoded/label_mapping.json"
...
while start_dt <= end_dt:
    ...
    in_path = os.path.join(INPUT_FOLDER, f"http_day_{day_str}.csv")
    out_path = os.path.join(OUTPUT_FOLDER, f"http_day_{day_str}_encoded.csv")
